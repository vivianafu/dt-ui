...
const Datepicker = forwardRef(
  ({
    ...
    const handleInputOnBlur = (event: ChangeEvent<HTMLInputElement>) => {
      const isValid = isValidDateFormat(dateFormat, event.target.value);
      ...
      return onChange(new Date(`${selectedDate.year}-${selectedDate.month}-${selectedDate.date}`));
    };
          ...
          <>
            ...
            <div className={clsx('relative inline-flex min-w-40', className)} ref={ref}>
              <Popover.Button
                ...
                defaultValue={getDisplayText(selectedDate, placeholder)}
